...
export default function CompteNav({ profile }: Props) {
  ...
  return (
    <aside className="w-64 flex-shrink-0 border-r border-navy/10 bg-white flex flex-col">
      {/* Profil */}
      <div className="p-5 border-b border-navy/10">
        <div className="flex items-center gap-3 mb-3">
          ...
          <div className="min-w-0">
            ...
            <div className="flex items-center gap-1.5 mt-0.5">
              <span className="text-[10px] font-semibold px-1.5 py-0.5 rounded" style={{ background: plan.color + '20', color: plan.color }}>
                {plan.label}
              </span>
        ...
        {profile.plan === 'gratuit' && (
          <div className="mt-2">
            ...
            <Link href="/compte/plan" className="block mt-2 text-center text-[11px] text-primary hover:underline font-medium">
              Passer Pro →
            </Link>
          </div>
        )}
