...
import { markChercheurContactAsRead } from '@/app/compte/messages/actions'

export default function MarkChercheurContactRead({ contactId }: { contactId: string }) {
  const [isPending, startTransition] = useTransition()

  function handleClick() {
    startTransition(async () => {
      await markChercheurContactAsRead(contactId)
    })
  }
